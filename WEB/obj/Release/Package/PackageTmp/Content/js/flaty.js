    ...
    if (jQuery().bootstrapWizard) {
        $('#form-wizard-1').bootstrapWizard({
            ...
            onNext: function (tab, navigation, index) {
                ...
                //        return false;
                //    }else{
                //        var fileInput = document.getElementById('fileName').files[0];
                //        var allowed = ["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "application/vnd.ms-excel"];
                //        var found = false;
