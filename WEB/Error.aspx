...
<body class="error-page">
    ...
    <form runat="server">
        ...
        <div class="error-wrapper">
            <h5><asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:Language, LABEL_500_TITLE %>"></asp:Literal><span>500</span></h5>
            <p>
                <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:Language, LABEL_500_MESSAGE_1 %>"></asp:Literal><br />
                <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:Language, LABEL_500_MESSAGE_2 %>"></asp:Literal> <%: System.Web.Configuration.WebConfigurationManager.AppSettings["CompanyName"] %>
            </p>
            <hr />
            <p class="clearfix">
