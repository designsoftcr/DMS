...
{
    /// <summary>
    /// Use to connect to the data base...
    /// </summary>
    /// 
    public class SqlHelper
    {
        ...
        public static int GetSqlExecutionTimeOut
        {
            get
            {
                ...
                if (System.Configuration.ConfigurationManager.AppSettings["sqlExecutionTimeOut"] == null || !string.IsNullOrEmpty(System.Configuration.ConfigurationManager.AppSettings["sqlExecutionTimeOut"].ToString())) return 0;
                try
                {
