...
namespace Sykes.Web.Data
{
    public class ExecuteScript: DatabaseEngine
    {
        ...
        public DataTable executeQuertyAndReturnDatatable(SqlConnection objConnection, string storedProcedureName, params object[] parameterValues)
        {
            DataTable dt = null;
            try
            {
                dt = SqlHelper.GetProcedureResults(objConnection, storedProcedureName, parameterValues);
                return dt;
            }
            catch (Exception ex)
            {
