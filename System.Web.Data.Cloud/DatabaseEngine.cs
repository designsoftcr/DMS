    ...
    public class DatabaseEngine
    {
        ...
        public string getTheCurrentConnectionString
        {
            get
            {
                ...
                {
                    if (System.Configuration.ConfigurationManager.ConnectionStrings["DefaultConnection"] == null) return string.Empty;
                    _strConnectionStirng = System.Configuration.ConfigurationManager.ConnectionStrings["DefaultConnection"].ToString();
        ...
        public int GetSqlExecutionTimeOut
        {
            get
            {
                if (System.Configuration.ConfigurationManager.AppSettings["sqlExecutionTimeOut"] == null) return 0;
                try
                {
